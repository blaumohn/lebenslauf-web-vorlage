...
/*
 * Ported from symfony/http-foundation Tests/HeaderUtilsTest.php.
 * Source: https://github.com/symfony/http-foundation/blob/main/Tests/HeaderUtilsTest.php
 * To update: copy the source file and change the namespace/use statements below.
 */

namespace Tests\Http\Lang;

use App\Http\Lang\HeaderUtils;
