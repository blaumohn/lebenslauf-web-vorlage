...
/*
 * Ported from symfony/http-foundation Tests/AcceptHeaderTest.php.
 * Source: https://github.com/symfony/http-foundation/blob/main/Tests/AcceptHeaderTest.php
 * To update: copy the source file and change the namespace/use statements below.
 */

namespace Tests\Http\Lang;

use App\Http\Lang\AcceptHeader;
use App\Http\Lang\AcceptHeaderItem;
